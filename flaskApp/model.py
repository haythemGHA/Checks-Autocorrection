...
class Model:
    ...
    def setup_ctc(self) -> None:
        ...
        # word beam search decoding (see https://github.com/githubharald/CTCWordBeamSearch)
            ...
            word_chars = open('D:/SimpleHTR/model/wordCharList.txt').read().splitlines()[0]
            corpus = open('D:/SimpleHTR/data/corpus.txt').read()
    ...
    def save(self) -> None:
        """Save model to file."""
        self.snap_ID += 1
        self.saver.save(self.sess, 'D:/SimpleHTR/model/snapshot', global_step=self.snap_ID)
